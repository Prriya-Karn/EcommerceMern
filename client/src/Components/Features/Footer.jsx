...
export const Footer = () => {
    return (
        <Fragment>
            ...
            <div className='sm:mt-5 mt-5 md:h-80 h-36  sm:w-1/2 w-56 p-3'>
            ...
            <div>
            <img className='lg:w-3/4 md:w-2/3 md:ml-10 sm:w-2/3 sm:ml-10 w-36
             rounded-lg md:mb-8 mb-2'
            src='../../../public/image/box1.png'/>
            </div>

            <div>
            <img className='lg:w-3/4 lg:ml-20 md:w-2/3 md:ml-20 sm:w-2/3 sm:ml-20 w-36
              rounded-lg'
